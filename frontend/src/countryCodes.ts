...
/** ITU E.164 calling codes for countries and territories. */
export const COUNTRY_DIAL_CODES: CountryDialCode[] = [
  ...
  { iso2: 'VI', name: 'Virgin Islands (U.S.)', dial: '1' },
...
export const COUNTRY_DIAL_CODES_SORTED: CountryDialCode[] = [
  ...
  ...COUNTRY_DIAL_CODES.filter((c) => c.iso2 !== 'IS').sort((a, b) =>
